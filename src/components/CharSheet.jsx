...
const GradeToValue = (grade) => parseGrade(grade).totalValue;

// Devuelve solo el valor base (ignora los '+')
const GradeBaseValue = (grade) => parseGrade(grade).baseValue;
...
const CharSheet = ({ id }) => {
  const { item: char, loading, error } = useItem('characters', id);
